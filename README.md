...
Com a conexão SSH é possível fazer conexões, a porta 22 de um servidor se ela estiver liberada pelo UFW, também é possível criar uma chave com ssh-keygen e coloca-lá em um novo usuário com adduser, é necessário colocar a chave pública no authorized_keys do usuário, permitir a ele determinados grupos ou da-ló permissão total ao servidor.
